...
class Message(db.Model):
    ...
    sender_id = db.Column(db.Integer, db.ForeignKey('phone_numbers.id'))
    recipient_id = db.Column(db.Integer, db.ForeignKey('phone_numbers.id'))
...
def connect_to_db(app):
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql:///pg_phone_backup'
